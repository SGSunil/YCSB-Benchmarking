...
DATABASES = {
    ...
    "cassandra3-cql": "com.yahoo.ycsb.db.CassandraCQLClient",	
...
def get_classpath_from_maven(module):
    try:
        ...
        mvn_output = check_output(["mvn", "-pl", "com.yahoo.ycsb:" + module, "-am", "package", "-DskipTests", "dependency:build-classpath", "-DincludeScope=compile", "-Dmdep.outputFilterFile=true"])
        print mvn_output
